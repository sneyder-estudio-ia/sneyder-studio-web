        ...
        <div className="max-w-4xl mx-auto px-6">
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-label text-[10px] font-bold tracking-[0.4em] uppercase text-cyan-400">Términos Legales</span>
            </div>
            <h1 className="font-headline text-4xl md:text-5xl font-black text-white mb-4">
              Términos de <span className="text-tertiary">Servicio</span>
            </h1>
