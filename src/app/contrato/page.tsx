        ...
        <div className="max-w-4xl mx-auto px-6">
          <header className="mb-12 animate-fade-in">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-label text-[10px] font-bold tracking-[0.4em] uppercase text-cyan-400">Contrato Oficial</span>
            </div>
            <h1 className="font-headline text-4xl md:text-5xl font-black text-white mb-4">
              Contrato de <span className="text-tertiary">Servicios</span>
            </h1>
